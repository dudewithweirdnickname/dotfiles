...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Print,  spawn,          SHCMD("scrot -d 1 ~/pics/screenshots/'%d-%m-%y-%h-%m-%s'.png") },
/*{ MODKEY|ShiftMask,             XK_Escape, quit,           {0} },
 */
	{ MODKEY,                       XK_minus,  spawn,          SHCMD("pactl set-sink-volume alsa_output.pci-0000_00_1b.0.analog-stereo -10%") },
	{ MODKEY|ShiftMask,             XK_minus,  spawn,          SHCMD("pactl set-sink-mute alsa_output.pci-0000_00_1b.0.analog-stereo 1") },
	{ MODKEY,                       XK_equal,  spawn,          SHCMD("pactl set-sink-volume alsa_output.pci-0000_00_1b.0.analog-stereo +10%") },
	{ MODKEY|ShiftMask,             XK_equal,  spawn,          SHCMD("pactl set-sink-mute alsa_output.pci-0000_00_1b.0.analog-stereo 0") },

	{ MODKEY,                       XK_q,      killclient,     {0} },
	{ MODKEY,                       XK_w,      spawn,          SHCMD("dmenu-bookmark.sh") },
	{ MODKEY|ShiftMask,             XK_e,      spawn,          SHCMD("st -e nmtui") },
	...
	{ MODKEY|ShiftMask,             XK_n,      spawn,          SHCMD("st -e nvim ~/.config/newsboat/urls") },
